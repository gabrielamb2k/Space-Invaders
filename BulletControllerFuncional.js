...
const createBulletController = (canvas, maxBulletsAtATime, bulletColor, soundEnabled) => {
...
const shootController = (controller, x, y, velocity, timeTillNextBulletAllowed = 0) => {
  if (
    controller.timeTillNextBulletAllowed <= 0 &&
